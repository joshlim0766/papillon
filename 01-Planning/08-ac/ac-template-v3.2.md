# Papillon Skill Acceptance Criteria Template v3.2
...
extract_keywords:
  ...
  algorithm:
    step_1: "입력 텍스트를 공백/구두점으로 토큰화"
    step_2: |
      **도메인 vocabulary 우선 매칭**:
        - domain_vocabulary에 포함된 토큰은 길이/stopword 무관하게 keyword로 채택
  ...
  examples:
    ...
    - input: "Do NOT trigger for simple typo corrections"
      domain_vocabulary: []
      output: ["trigger", "simple", "typo", "corrections"]
