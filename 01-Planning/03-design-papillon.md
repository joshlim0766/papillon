...
11. 종료 시 `00-interview/00-summary.md`에 전체 요약을 생성한다: 확인된 요구사항, 핵심 제약, 암시적 전제 조건 목록, Deferred 항목과 사유. 인터뷰를 건너뛴 경우(항목 3에서 불필요 판단)는 컨텍스트 수집 결과를 기반으로 요약을 생성한다. 이 디렉토리가 이후 체급 판정과 Draft 생성의 입력이 된다.
