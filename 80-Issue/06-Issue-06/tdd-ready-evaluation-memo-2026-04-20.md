...
- [~] **2f 실측 데이터 수집** — `tracing-2f-2026-04-20.md` 에 실시간 관찰 3건 누적 중. 관찰 1(시간축) + 2(공간축) + 3(실패 경로 계약 공백으로 인한 3R P0/P1 재귀 패턴). 2f 완료 시 정식 tracing 으로 확장.
- [ ] 환류 §8 tracing 4건 정식 적용 — 2e 완료, 2f 완료 후 종합.
- [ ] **신호 #9 실패 경로 계약 신설 검토** — v0.2.0 draft 갱신 시. 2f 3라운드 재귀 P0/P1 패턴이 실증 근거.
