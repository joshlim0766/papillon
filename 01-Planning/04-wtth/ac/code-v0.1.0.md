...
> 공통 reviewer AC(`common-v0.1.0.md`)를 기반으로 CODE 페르소나 특이 사항을 override한다.
...
parent_ac: "wtth:reviewer v0.1.0 (common-v0.1.0.md)"
version: "0.1.0"
...
identity:
  ...
  input_spec:
    description: |
      ...
      현 단계(v0.1.0)에서는 code snippet 형식만 지원한다. diff 형식은
