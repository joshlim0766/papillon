...
> **2026-04-20 집 세션 재평가 주석**: 원본 `shackled-*.md` 10개 전수 독립 평가 완료. phase2c → ★★★★★ 상향 근거 + phase2e → ★★★★ 상향 근거(배치 재작성으로 AP-1 상류 해소) + 미등재 5건(phase2b/2d/2f/use-block/use-tenant) 각자 다른 신호 모범 확인. 본 테이블 재작성과 v0.2.0 MUST/SHOULD 재분류는 **shackled 2e/2f 실측 완료 후 회사 세션**에서 확정. 평가 상세: `tdd-ready-evaluation-memo-2026-04-20.md`.
