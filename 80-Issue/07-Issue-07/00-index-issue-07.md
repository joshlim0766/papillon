...
1. **섹션 수 ≥ 18개** — **카운트 기준**: 번호 매겨진 최상위 섹션(§1~§N) + 번호 서브섹션(§N.M)만 집계. `## 개요` / `## Context` 류 본문 내부 템플릿 헤더는 카운트 제외. (2026-04-21 기준 15개: §1~§13 + §7.1 + §9.1)
2. **단일 섹션 길이 ≥ 500줄** (2026-04-21 기준 최대 §1 심각도 71줄)
