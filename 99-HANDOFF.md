...
## 현재 작업 위치
`80-Issue/06-Issue-06/tdd-ready-spec-v0.2.0.md` **발행 완료** (2026-04-20 회사). 2e + 2f 실측 2건 기반 환류 종료. 신설 #9 실패 경로 계약 MUST + 확장 3건 (#2/#7B/#8) + 지시서 분할 요건 + 체계 개선 2건 (실용 노선 / 품질 경계 4지표) + AP 학습 케이스 2건 박제. Phase 3 진입 후 배치 엔진 shackled TDD 가 v0.3.0 재검토 트리거.
