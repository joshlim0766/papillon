...
**중요 경계**: 본 문서는 **시간/공간 축 분할** 만 다룬다. 2f 3라운드 P0/P1 재귀 패턴 분석(`tracing-2f-2026-04-20.md` 관찰 3)에서 드러난 **"실패 경로 계약 축"** 은 별도 축이며 본 설계로 해결되지 않는다. Claude 즉답 인용: "지시서 분할은 필요조건이지만 충분조건은 아님". 실패 경로 계약은 Issue-06 #1 스펙의 신호 #9 신설(또는 #8 확장) 후보로 별도 관리.
